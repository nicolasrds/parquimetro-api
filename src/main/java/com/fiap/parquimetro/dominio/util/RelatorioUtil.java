...
public class RelatorioUtil {
    ...
    public byte[] gerarRelatorioEmByte(String caminhoCompletoRelatorio, String nomeRelatorio,
                                       List listaDeObjetos, Map<String, Object> map) throws Exception {

        preencherParamentro(map, listaDeObjetos, nomeRelatorio, caminhoCompletoRelatorio);
    ...
    private void preencherParamentro(Map<String, Object> parametros, List dados, String nomeRelatorio,
                                     String caminhoCompletoRelatorio) throws Exception {
        if (dados.isEmpty()) {
            throw new Exception("A grade de dados está vazia! Realize Consulta para gerar Impressão.");
        }
        parametros.put("imgRod", pegaLocalImagem("parking_car.png"));
